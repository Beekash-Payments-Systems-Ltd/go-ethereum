...
import (
	...
	"github.com/Beekash-Payments-Systems-Ltd/go-ethereum/consensus/misc"
...
func makeDifficultyCalculator(bombDelay *big.Int) func(time uint64, parent *types.Header) *big.Int {
	...
	return func(time uint64, parent *types.Header) *big.Int {
		// https://github.com/Beekash-Payments-Systems-Ltd/EIPs/issues/100.
		// algorithm:
		// diff = (parent_diff +
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/Beekash-Payments-Systems-Ltd/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
